...
<div id="content" class="content">
	<ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item">Keputusan Rektor</li>
	</ol>
    <h1 class="page-header">Keputusan Rektor</h1>
    <div class="row my-3">
                ...
                <div class="row no-gutters mx-0">
                    ...
                    <div class="cst-text text-white">
                        <div class="card-body">
                            ...
                            <h5 class="card-text"><?php echo $open_ka ?></h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row no-gutters mx-0">
                    ...
                    <div class="text-white">
                        <div class="card-body">
                            ...
                            <h5 class="card-text"><?php echo $done_ka ?></h5>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Modal ADD -->
    <div class="modal fade" id="add_KA" tabindex="-1" role="dialog" aria-labelledby="add_KA" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="adduuu">Tambah Keputusan Rektor</h5>
                ...
                <div class="col-xl">
                    <form action="<?php echo base_url('ortala/add_prokum'); ?>" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <input type="hidden" name="id_kat" value="5">
							<input type="hidden" name="nama_kat" value="Keputusan Rektor">
                            <input type="hidden" name="url" value="keputusan_rektor">
    ...
    <div class="modal fade" id="editprokum" tabindex="-1" role="dialog" aria-labelledby="editprokum" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                	<h5 class="modal-title">Edit Keputusan Rektor</h5>
                	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    	<span aria-hidden="true">&times;</span>
                	</button>
                </div>
    ...
    <div class="modal fade" id="delprokum" tabindex="-1" role="dialog" aria-labelledby="delprokumm" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                	<h5 class="modal-title" id="delprokumm">Hapus keputusan Rektor</h5>
                	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    	<span aria-hidden="true">&times;</span>
                	</button>
                </div>
