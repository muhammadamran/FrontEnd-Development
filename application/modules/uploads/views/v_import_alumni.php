                    ...
                    <div class="card border-0 bg-white text-black text-truncate mb-4">
                        <div class="card-body">
                                ...
                                <div class="col-xl-7 col-lg-8">
                                    <?php echo $this->session->flashdata('alumni') ?>
                                    <form method="POST" action="<?php echo base_url() ?>uploads/alumni" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="exampleInputEmail2">UNGGAH FILE EXCEL ALUMNI</label>
                                            <span class="ml-2">
                                            ...
                                            <input for="alumni" type="file" name="alumni" class="form-control">
                                        </div>

                                        <button id="alumni" type="submit" class="btn btn-success">UPLOAD REKAP ALUMNI</button>
                                    </form>
                                </div>
                            </div>
                        </div>
